...
class BraindumpConfig:
    def __init__(self):
        standard_config_path = QStandardPaths.writableLocation(QStandardPaths.AppConfigLocation)

        config_dir = os.path.join(standard_config_path, "braindump")
        ...
        if not os.path.exists(self.config_file):
            ...
            QMessageBox.information(None, "Configuration Created",
